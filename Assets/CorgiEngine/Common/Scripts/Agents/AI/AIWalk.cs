...
{	
	...
	public class AIWalk : MonoBehaviour
	{
	    ...
	    protected virtual void CheckForHoles()
	    {
			...
			RaycastHit2D raycast = MMDebug.RayCast(raycastOrigin, Vector2.down, HoleDetectionRaycastLength, _controller.PlatformMask | _controller.MovingPlatformMask | _controller.OneWayPlatformMask | _controller.MovingOneWayPlatformMask,  Color.yellow, true);
